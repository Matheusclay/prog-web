<x-app-layout>
    ...
    <h5 class="mt-3 text-center">O melhor Gerenciador de Hoteis De PP!</h5>


<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="/images/quarto1.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="/images/quarto2.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="/images/quarto3.jpg" class="card-img-top" alt="...">
      <div class="card-body">
